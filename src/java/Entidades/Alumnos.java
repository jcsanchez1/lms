...
@NamedQueries({
    ...
    , @NamedQuery(name = "Alumnos.findByFotoUrl", query = "SELECT a FROM Alumnos a WHERE a.fotoUrl = :fotoUrl")})
public class Alumnos implements Serializable {
    ...
    public Alumnos(BigDecimal id, String identidad, String nombres, String apellidos, String telefono, String direccion, Object latitud, Object longitud, Date fechaNacimiento, String fotoUrl) {
        this.id = id;
