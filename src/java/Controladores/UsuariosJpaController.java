...
public class UsuariosJpaController implements Serializable {
        ...
        try {
            ...
            for (Alumnos alumnosListOldAlumnos : alumnosListOld) {
                if (!alumnosListNew.contains(alumnosListOldAlumnos)) {
                    ...
                    illegalOrphanMessages.add("You must retain Alumnos " + alumnosListOldAlumnos + " since its fkUsuario field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
    ...
    public void destroy(BigDecimal id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<String> illegalOrphanMessages = null;
            List<Alumnos> alumnosListOrphanCheck = usuarios.getAlumnosList();
            for (Alumnos alumnosListOrphanCheckAlumnos : alumnosListOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Usuarios (" + usuarios + ") cannot be destroyed since the Alumnos " + alumnosListOrphanCheckAlumnos + " in its alumnosList field has a non-nullable fkUsuario field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
