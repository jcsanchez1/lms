...
import Entidades.RespuestasForos;
import java.util.ArrayList;
import java.util.List;
import Entidades.ArreglosPagos;
import Entidades.TareasAlumnos;
import Entidades.RespuestasPruebasAlumnos;
import Entidades.Pagos;
import Entidades.PruebasAlumnos;
import Entidades.CarrerasAlumnos;
import Entidades.AlumnosSecciones;
import Entidades.Saldos;
...
public class AlumnosJpaController implements Serializable {
    ...
    public AlumnosJpaController() {
        this.emf = Persistence.createEntityManagerFactory("LMSPU");
    }
